...
och summerar ihop. Om en fraktion får mer än $t_j$ makt så blir du avsatt.
...
Sedan följer $M$ rader som vardera innehåller $N+1$ heltal. Det första är $_i$, den maximala makten den
$i$:te fraktionen kan få. De resterande $N$ heltalen är $y_{i,j}$, hur mycket adelsman $j$ stärker fraktion $i$ per krona.
