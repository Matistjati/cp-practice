...
You have a list $N$ of integers $a_0, a_1, \dots, a_{N-1}$. In the beginning, $A_i=0$. Additionally, each number
...
\begin{itemize}
    ...
    \item Type 2: add $v$ to all active $a_i$ that are active in the interval $a_l, a_{l+1}, \dots, a_{r}$.
